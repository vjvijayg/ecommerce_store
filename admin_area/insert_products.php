...
<html>
	<head>
		...
		<script src="https://cloud.tinymce.com/stable/tinymce.min.js?apiKey=hypw9ybx1v39qlt2mrahdos1vbz65of02eub4206awbu9oie"></script>
									...
									<select name="product_cat" class="form-control">
										...
										<?php
											...
											while ($row_p_cats=mysqli_fetch_array($run_p_cats)){
												...
												echo "<option valu='$p_cat_id'>$p_cat_title</option>";
											}
										?>
									</select>	
								</div>
